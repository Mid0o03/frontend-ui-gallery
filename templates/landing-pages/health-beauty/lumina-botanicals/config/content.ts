...
export const CONTENT = {
    hero: {
        title: 'Nurture Your Skin with Nature\'s Purest Essence',
        subtitle: 'Ethically sourced, 100% organic botanical skincare crafted to reveal your natural radiance.',
    ...
    newsletter: {
        title: 'Join the Botanical Journal',
        description: 'Subscribe to receive skincare tips, exclusive offers, and early access to new launches.',
        placeholder: 'Enter your email address',
        buttonText: 'Subscribe',
    },
    footer: {
        about: `${BRANDING.name} is dedicated to bringing you the finest botanical skincare, rooted in science and nurtured by nature.`,
